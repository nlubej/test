...
const nonLifeReinsuranceUWSummaryMapping = require('@config-standard/reinsurance-underwriting/component/NonLifeReinsuranceUWSummary/lib/NonLifeReinsuranceUWSummaryMapping');
...
module.exports = function summary(commonBody, body, previousCommonBody) {
  ...
  nonLifeReinsuranceUWSummaryMapping(commonBody, body, previousCommonBody, summaryData);
